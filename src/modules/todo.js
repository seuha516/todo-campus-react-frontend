...
const [LIST_TODO, LIST_TODO_SUCCESS, LIST_TODO_FAILURE] = createRequestActionTypes('todo/LIST_TODO');
const [WRITE_TODO, WRITE_TODO_SUCCESS, WRITE_TODO_FAILURE] = createRequestActionTypes('todo/WRITE_TODO');
const [UPDATE_TODO, UPDATE_TODO_SUCCESS, UPDATE_TODO_FAILURE] = createRequestActionTypes('todo/UPDATE_TODO');
const [REMOVE_TODO, REMOVE_TODO_SUCCESS, REMOVE_TODO_FAILURE] = createRequestActionTypes('todo/REMOVE_TODO');
